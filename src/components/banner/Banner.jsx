        ...
        <div className="px-20 pt-20 pb-0 flex flex-col items-center justify-center bg-[#FFFFFF] gap-10">
            <div className="flex flex-col items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                    <Link to={"/play.google.com/store/games?hl=en"} className="hover:cursor-pointer">
                        <button className="px-6 py-3 rounded-lg bg-[#D2D2D2] border border-[#D2D2D2] flex items-center gap-2 font-[inter] font-semibold text-[20px] leading-[auto] tracking-[0%] text-[#001931]"><img src={googlePlay} alt="Google Play" /> Google Play</button>
                    </Link>
                    <Link to={"/https://www.apple.com/app-store/"} className="hover:cursor-pointer">
                        <button className="px-6 py-3 rounded-lg bg-[#D2D2D2] border border-[#D2D2D2] flex items-center gap-2 font-[inter] font-semibold text-[20px] leading-[auto] tracking-[0%] text-[#001931]"><img src={appStore} alt="App Store" /> App Store</button>
                    </Link>
                </div>
            </div>
            <div>
